...
//  if (!DC_CONFIG.DC_API_HOST) return;
    ...
    $.ajax({
      ...
      error: function(e,h,r){
        if (options.withAuth && e.status==401) {
          ...
          window.location.href='https://u1403.ambari.apache.org:8443/gateway/knoxsso/api/v1/websso?originalUrl='+originalUrl;
        } else {
          options.error ? options.error : toastr.error('数据请求失败');
        }
      },
      ...
      beforeSend: options.beforeSend ? options.beforeSend : function(xhr){
        //xhr.setRequestHeader('Cookie', 'hadoop-jwt='+$.fn.dcCookie('hadoop-jwt'));
  ...
  $.fn.dcGet = function(){
    ...
    var error = arguments.length == 3 && (typeof arguments[1]=='function' && typeof arguments[2]=='function' ) ? arguments[2] 
      : (arguments.length > 3 && (typeof arguments[2]=='function' && typeof arguments[3]=='function' ) ? arguments[3] : null);
    var option = {url: url, type: 'GET', data: data, success: success, error: error};
    $.fn.dcAjax(option);
  };
  $.fn.dcPost = function(){
    var url = arguments[0];
    ...
    var error = arguments.length == 3 && (typeof arguments[1]=='function' && typeof arguments[2]=='function' ) ? arguments[2] 
      : (arguments.length > 3 && (typeof arguments[2]=='function' && typeof arguments[3]=='function' ) ? arguments[3] : null);
    var option = {url: url, type: 'POST', data: data, success: success, error: error};
    $.fn.dcAjax(option);
  };
})(jQuery);